...
| Entity | Grade (post-load DQ) | Idempotency recheck (re-run: row count + key set stable) | Load strategy proven | Notes |
| --- | --- | --- | --- | --- |
| | A | PASS / n/a | FULL_MERGE / INCREMENTAL_MERGE / APPEND_ONLY / SCD2 | e.g. inherited from sibling of same strategy |
