...
A populated prior build (a V1/MVP, or a sibling ETL variant per `discovery-protocol.md` Phase 2B.1)
...
- **Unsupported / Partial KPIs whose missing input is structural** (a missing entity, dimension,
  ...
  Step 2.7** (`discovery-protocol.md` Step 2C.4) — the two disposition paths apply unchanged:
