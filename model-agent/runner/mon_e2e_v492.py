...
Separate from launch_e2e_v492.py so a dead launcher shell never orphans the monitoring
...
LITERAL_SIGNALS = (
        ...
        ("shrink-guard-user-king FIRED", "v492 shrink-guard user-king"),
        ...
        ("mv-inflight-repair-persist FIRED", "v492 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v492 artifact rewritten"),
        ...
        ("dup-product-same-domain-merge FIRED", "v492 same-domain dup merged"),
        ("immutable-merge-same-entity-allowed FIRED", "v492 dedup merge allowed"),
