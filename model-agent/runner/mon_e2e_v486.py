...
Separate from launch_e2e_v486.py so a dead launcher shell never orphans the monitoring
...
PROFILE = "my-uae"
RUN_ID = "68136405326434"
CATALOG = "vibe_e2e_v486"
BUSINESS = "coffee_roastery"
MIRROR = "/tmp/e2e486_logs"
PULSES = "/tmp/e2e486_pulses.txt"
...
def scan():
    ...
    for pat, label in (
        ...
        ("mv-inflight-repair-persist FIRED", "v486 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v486 artifact rewritten"),
