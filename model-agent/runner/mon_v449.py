#!/usr/bin/env python3
"""v4.4.9 dual-run monitor: automotive (fe-aws) + shipping_ports (fe-gcp).
Every POLL_S seconds append a compact status block for BOTH runs (life-cycle + per-task state +
tail of the freshest volume info log) to /tmp/v449_mon.txt. Exits when both runs are TERMINATED.
...
RUNS = [
    ("automotive", "fe-aws", "1028756527442088", "vibe_automotive_v1"),
    ("shipping_ports", "fe-gcp", "241798883942013", "vibe_shipping_ports_v1"),
]
OUT = "/tmp/v449_mon.txt"
POLL_S = 180
