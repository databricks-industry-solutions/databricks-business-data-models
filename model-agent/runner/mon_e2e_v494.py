...
Separate from launch_e2e_v494.py so a dead launcher shell never orphans the monitoring
...
PROFILE = "my-uae"
RUN_ID = str(json.load(open("/tmp/e2e494_run.json"))["run_id"])
CATALOG = "vibe_e2e_v494"
BUSINESS = "coffee_roastery"
MIRROR = "/tmp/e2e494_logs"
PULSES = "/tmp/e2e494_pulses.txt"
...
LITERAL_SIGNALS = (
        ("v494-physical-names-before-modeljson FIRED", "v494 names resolved pre-serialization"),
        ...
        ("shrink-guard-user-king FIRED", "v494 shrink-guard user-king"),
        ...
        ("mv-inflight-repair-persist FIRED", "v494 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v494 artifact rewritten"),
        ...
        ("dup-product-same-domain-merge FIRED", "v494 same-domain dup merged"),
        ("immutable-merge-same-entity-allowed FIRED", "v494 dedup merge allowed"),
