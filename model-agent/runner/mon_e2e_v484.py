...
Separate from launch_e2e_v484.py so a dead launcher shell never orphans the monitoring
...
PROFILE = "my-uae"
RUN_ID = "324473523270028"
CATALOG = "vibe_e2e_v484"
BUSINESS = "coffee_roastery"
MIRROR = "/tmp/e2e484_logs"
PULSES = "/tmp/e2e484_pulses.txt"
...
def scan():
    hits = {}
    for pat, label in (
        ("mv-inflight-repair-persist FIRED", "v484 repair captured"),
        ("mv-artifact-rewrite-on-repair FIRED", "v484 artifact rewritten"),
