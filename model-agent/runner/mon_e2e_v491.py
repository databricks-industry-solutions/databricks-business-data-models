...
Separate from launch_e2e_v491.py so a dead launcher shell never orphans the monitoring
...
PROFILE = "my-uae"
RUN_ID = str(json.load(open("/tmp/e2e491_run.json"))["run_id"])
CATALOG = "vibe_e2e_v491"
BUSINESS = "coffee_roastery"
MIRROR = "/tmp/e2e491_logs"
PULSES = "/tmp/e2e491_pulses.txt"
...
LITERAL_SIGNALS = (
        ...
        ("shrink-guard-user-king FIRED", "v491 shrink-guard user-king"),
        ...
        ("mv-inflight-repair-persist FIRED", "v491 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v491 artifact rewritten"),
        ...
        ("dup-product-same-domain-merge FIRED", "v491 same-domain dup merged"),
        ("immutable-merge-same-entity-allowed FIRED", "v491 dedup merge allowed"),
