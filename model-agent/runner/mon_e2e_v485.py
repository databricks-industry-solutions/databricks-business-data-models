...
Separate from launch_e2e_v485.py so a dead launcher shell never orphans the monitoring
...
PROFILE = "my-uae"
RUN_ID = "244263508185840"
CATALOG = "vibe_e2e_v485"
BUSINESS = "coffee_roastery"
MIRROR = "/tmp/e2e485_logs"
PULSES = "/tmp/e2e485_pulses.txt"
...
def scan():
    hits = {}
    for pat, label in (
        ("mv-inflight-repair-persist FIRED", "v485 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v485 artifact rewritten"),
