...
Separate from launch_e2e_v495.py so a dead launcher shell never orphans the monitoring
...
LITERAL_SIGNALS = (
        ("v495-physical-names-before-modeljson FIRED", "v495 names resolved pre-serialization"),
        ...
        ("shrink-guard-user-king FIRED", "v495 shrink-guard user-king"),
        ...
        ("mv-inflight-repair-persist FIRED", "v495 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v495 artifact rewritten"),
        ...
        ("dup-product-same-domain-merge FIRED", "v495 same-domain dup merged"),
        ("immutable-merge-same-entity-allowed FIRED", "v495 dedup merge allowed"),
