...
Separate from launch_e2e_v487.py so a dead launcher shell never orphans the monitoring
...
PROFILE = "my-uae"
RUN_ID = "597397954843244"
CATALOG = "vibe_e2e_v487"
BUSINESS = "coffee_roastery"
MIRROR = "/tmp/e2e487_logs"
PULSES = "/tmp/e2e487_pulses.txt"
...
def scan():
    ...
    for pat, label in (
        ...
        ("mv-column-rename-before-prune FIRED", "v487 rename instead of prune"),
        ("mv-column-prevalidate-prune FIRED", "column pruned (rename impossible)"),
        ("mv-inflight-repair-persist FIRED", "v487 repair captured"),
        ("mv-artifact-mirrors-executed FIRED", "v487 artifact rewritten"),
