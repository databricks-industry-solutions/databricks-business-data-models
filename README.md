...
> **⚡ From reference model to real data:** the [**`model-genie-skills/`**](./model-genie-skills/) folder ships a suite of Genie Code skills that take any model here and **form it to a customer's real data on Databricks** — assess → build → validate → document, one domain at a time. [See details below ↓](#model-genie-skills)
...
[**`model-genie-skills/`**](./model-genie-skills/) folder provides: a suite of **Genie Code
...
**Get started:** see [**`model-genie-skills/README.md`**](./model-genie-skills/README.md) for
the full walkthrough, or jump to the [developer docs index](./model-genie-skills/docs/developer/index.md).
